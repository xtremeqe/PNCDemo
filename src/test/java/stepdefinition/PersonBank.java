...
public class PersonBank {
	...
	public void pbta_cursor_is_placed_on_the_BANKING_menu() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}

	@Then("PBTa the drop down appear with chcking link")
	public void pbta_the_drop_down_appear_with_chcking_link() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}

	@When("PBTa the user click on Checking link")
	public void pbta_the_user_click_on_Checking_link() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}
	...
	public void pbtb_cursor_is_placed_on_the_BANKING_menu() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}

	@Then("PBTb the drop down appear with Savings link")
	public void pbtb_the_drop_down_appear_with_Savings_link() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}

	@When("PBTb the user click on Savings link")
	public void pbtb_the_user_click_on_Savings_link() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}
	...
	public void pbtc_cursor_is_placed_on_the_BANKING_menu() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}

	@Then("PBTc the drop down appear with crdit cards link")
	public void pbtc_the_drop_down_appear_with_crdit_cards_link() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}

	@When("PBTc the user click on Savings link")
	public void pbtc_the_user_click_on_Savings_link() {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
	}
	...
	@After
	public void after() {
		System.out.println("Driver going to quit after PersonBank");
